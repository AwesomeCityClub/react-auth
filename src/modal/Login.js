...
const Login = () => {
  ...
  <div class="my-2 flex justify-center">
    <button class="mt-2 w-60 border bg-violet-500 p-2 font-sans rounded-full hover:bg-violet-600 text-white">LOGIN</button>
  </div>
  <div className='text-center underline cursor-pointer text-sm'> SIGN UP </div>
